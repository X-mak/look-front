...
export default {
  ...
  methods: {
    ...
    cancelClass() {
      ...
      this.$emit("changeVisible", this.dialogVisible);
    ...
    confirmClass() {
      ...
      if (this.class.courseName === "" || this.class.courseName == null) {
        ...
        this.class.courseImg === "" ||
        this.class.courseImg == null
      ) {
        open("课程封面不能为空!", "warning");
      } else if (this.class.courseClass.age == null) {
        open("课程分类不能为空!", "warning");
      } else if (this.class.courseClass.subject == null) {
        open("课程分类不能为空!", "warning");
      } else {
        request({
          url: "/course",
